...
from .util import IntermediateLayerGetter, Normalize, _ovewrite_value_param, _log_api_usage_once
from .mobilenetv3 import MobileNetV3, mobilenet_v3_large
...
class _SimpleSegmentationModel(nn.Module):
    ...
    def forward(self, x: torch.Tensor, normalize: bool=True, return_feat: bool=False):
        if normalize:
            x = self.normalize(x)
